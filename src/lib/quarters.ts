...
/**
 * IRS estimated-tax period for `now`:
 *   Q1: Jan 1 – Mar 31 (due Apr 15)
 *   Q2: Apr 1 – May 31 (due Jun 15)
 *   Q3: Jun 1 – Aug 31 (due Sep 15)
 *   Q4: Sep 1 – Dec 31 (due Jan 15 next year)
 *
 * These are the IRS estimated-tax periods — Q2 is only 2 months and Q3
 * starts in June. The Dashboard tracker, YTD-catchup mirror, and
 * `getQuarterPayments` all rely on this mapping so a June 5 business
 * income entry is attributed to Q3 (the period whose deadline is Sep 15).
 */

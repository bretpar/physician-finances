...
const FIELDS: FieldDef[] = [
  ...
  { key: "taxesAlreadyWithheldOrPaid", label: "− Taxes already withheld/paid" },
  { key: "federalWithheld", label: "  (Federal withheld)" },
  { key: "stateWithheld", label: "  (State withheld)" },
  { key: "quarterlyPayments", label: "  (Quarterly payments)" },
  { key: "taxSavings", label: "  (Tax savings set aside)" },
  { key: "remainingTaxToCover", label: "= Remaining tax to cover" },

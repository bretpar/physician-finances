  ...
  const scopedBaseInputs = useMemo(() => {
    ...
    const buildInput = (
      ...
      return {
        ...
        seEligibleBusinessExpenses: canonicalBusiness.seEligibleExpenses + seEligibleHomeOfficeDeduction + forecastBusinessExpenses + cu.business.seEligibleExpenses,
        ...
        // Standalone SELF-EMPLOYED employer plan money (employer Solo 401(k),
        // SEP) is routed through the business/employer retirement path. W-2
        // employer contributions are excluded: they are never a personal

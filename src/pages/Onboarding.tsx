        ...
        <CardContent className="space-y-6 p-5 sm:p-8">
          ...
          <div className="flex items-center justify-between gap-3 border-t border-border pt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button type="button" data-testid="onboarding-continue-button" data-testid-legacy="onboarding-continue" onClick={continueStep} disabled={saving || (user && isLoading)}>{saving ? "Saving…" : step === TOTAL_STEPS ? (merged.subscriptionTier === "premium" ? "Continue with Premium" : "Start with Free") : "Continue"}</Button>
            </div>
          </div>
        </CardContent>
      </Card>
